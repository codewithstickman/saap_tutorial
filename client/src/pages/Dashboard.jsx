...
function Dashboard() {
  ...
  const getUserFunc = useSaapStore(getUserDataSelector);
  const userData = useSaapStore(getUserSelector);
  const getUserTx = useSaapStore(getUserTXSelector);
  const userTransaction = useSaapStore(getTransactionsSelector);

  const paymentLink = `${window.location.origin}/merchant/` + `${userData ? userData.username :"demo_user"}`;
...
//     {
//       id: 1,
//       address: "0x35f9621e9d943e46c418b9556bdbcf5214ae0f47",
//       chain: "Base",
//       amount: "+ 20.00 USDC",
//       date: "Oct 24, 2026",
//       type: "receive",
      ...
      <header className="dashboard-header">
        <div className="balance-section">
          ...
          <h1 className="balance-amount">
            ${userData && userData.balance} <span className="currency">USDC</span>
          </h1>
        </div>
        <div className="btns">
      ...
      <div className="dashboard-grid">
        ...
        <section className="share-section">
          ...
          <p className="section-desc">
            Share your link or embed the button on your website.
          </p>
                ...
                <div className="transaction-item" key={tx._id}>
                  ...
                  <div className="tx-chain">
                    <span className="chain-badge">
                      {tx.chain ? tx.chain.toLocaleLowerCase() : "base"}
                    </span>
                  </div>
